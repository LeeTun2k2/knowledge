...
[![Neo Kim's avatar](https://substackcdn.com/image/fetch/$s_!OHOm!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc103940f-0d8b-47e7-9a33-013202e17bb8_389x389.jpeg)](https://substack.com/@systemdesignone)[![Sahil Sarwar's avatar](https://substackcdn.com/image/fetch/$s_!aKfW!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc506984c-3cb2-4ed6-b608-2eb56c13149f.jpeg)](https://substack.com/@sahilserver)

[Neo Kim](https://substack.com/@systemdesignone) and [Sahil Sarwar](https://substack.com/@sahilserver)
...
[![](https://substackcdn.com/image/fetch/$s_!O7f5!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9377721d-1539-4d2f-bd53-df0daccef548_1600x900.png)](https://www.augmentcode.com/?utm_source=systemdesign&utm_medium=newsletter)
...
[![](https://substackcdn.com/image/fetch/$s_!kovI!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Ffa356309-9aad-40d0-a82c-36c98bf5cea7_1200x630.png)](https://www.linkedin.com/in/sahilsarwar1/)
...
[![](https://substackcdn.com/image/fetch/$s_!M9Hh!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9efc1b98-b793-48a3-ba24-865497ec5824_1600x957.png)](https://substackcdn.com/image/fetch/$s_!M9Hh!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9efc1b98-b793-48a3-ba24-865497ec5824_1600x957.png)
...
**No Shared Memory**
  ...
  * We need idempotency[1](https://newsletter.systemdesign.one/p/distributed-systems#footnote-1-178294033), retry logic, and consensus algorithms[2](https://newsletter.systemdesign.one/p/distributed-systems#footnote-2-178294033) to maintain system correctness even when messages are lost or fail.
...
**Message Communication**
  ...
  * Nodes communicate using protocols such as [gRPC](https://grpc.io/)[3](https://newsletter.systemdesign.one/p/distributed-systems#footnote-3-178294033), [HTTP](https://developer.mozilla.org/en-US/docs/Web/HTTP/Guides/Session)[4](https://newsletter.systemdesign.one/p/distributed-systems#footnote-4-178294033), [Kafka events](https://kafka.apache.org/)[5](https://newsletter.systemdesign.one/p/distributed-systems#footnote-5-178294033), and so on.
...
Distributed systems rely heavily on TCP[6](https://newsletter.systemdesign.one/p/distributed-systems#footnote-6-178294033) because it provides:
...
[![](https://substackcdn.com/image/fetch/$s_!FylA!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2f71cb39-e7c6-4fe5-83b7-54c57e17ac6f_1600x686.png)](https://substackcdn.com/image/fetch/$s_!FylA!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2f71cb39-e7c6-4fe5-83b7-54c57e17ac6f_1600x686.png)
...
You can consider TCP as a “mailman” and TLS[7](https://newsletter.systemdesign.one/p/distributed-systems#footnote-7-178294033) as the envelope with a lock and signature. TLS ensures:

  * Encryption[8](https://newsletter.systemdesign.one/p/distributed-systems#footnote-8-178294033): nobody can read the data

  * Authentication: you know who you’re talking to

  * Integrity: messages can’t be altered without detection

[![](https://substackcdn.com/image/fetch/$s_!0O62!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa53bfe58-6776-4449-9396-365c94f0501a_1600x622.png)](https://substackcdn.com/image/fetch/$s_!0O62!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa53bfe58-6776-4449-9396-365c94f0501a_1600x622.png)
...
That’s where DNS (Domain Name System) comes in:
  ...
  * And acts as a basic service discovery[9](https://newsletter.systemdesign.one/p/distributed-systems#footnote-9-178294033) mechanism.

[![](https://substackcdn.com/image/fetch/$s_!Hbpk!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F83ff49cf-9b3d-4210-abc1-02f0a30bcb8e_1600x1164.png)](https://substackcdn.com/image/fetch/$s_!Hbpk!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F83ff49cf-9b3d-4210-abc1-02f0a30bcb8e_1600x1164.png)
...
[![](https://substackcdn.com/image/fetch/$s_!3yG6!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3f4ba4a0-5a5e-4f9e-9042-ad12131b342e_1920x1794.gif)](https://substackcdn.com/image/fetch/$s_!3yG6!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3f4ba4a0-5a5e-4f9e-9042-ad12131b342e_1920x1794.gif)
...
Each machine has its own local clock… and these clocks can drift[10](https://newsletter.systemdesign.one/p/distributed-systems#footnote-10-178294033).
...
This keeps the correct order[11](https://newsletter.systemdesign.one/p/distributed-systems#footnote-11-178294033): send < receive.
...
Algorithms like Raft[12](https://newsletter.systemdesign.one/p/distributed-systems#footnote-12-178294033) solve this in a clean and predictable way:
...
[![](https://substackcdn.com/image/fetch/$s_!BQMd!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9c66f378-1059-491d-aa55-215bf0de48f8_1600x883.png)](https://substackcdn.com/image/fetch/$s_!BQMd!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9c66f378-1059-491d-aa55-215bf0de48f8_1600x883.png)
...
[Subscribe](https://newsletter.systemdesign.one/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.systemdesign.one%2Fp%2Fdistributed-systems&utm_source=paywall&utm_medium=web&utm_content=178294033)

[Already a paid subscriber? **Sign in**](https://substack.com/sign-in?redirect=%2Fp%2Fdistributed-systems&for_pub=systemdesignone&change_user=false)

PreviousNext

[![Sahil Sarwar's avatar](https://substackcdn.com/image/fetch/$s_!aKfW!,w_52,h_52,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc506984c-3cb2-4ed6-b608-2eb56c13149f.jpeg)](https://substack.com/@sahilserver?utm_source=byline)| A guest post by| [Sahil Sarwar](https://substack.com/@sahilserver?utm_campaign=guest_post_bio&utm_medium=web)Software engineer, writer. Asking the 'whys', peeling apart the layers, one at a time, of systems, life and the magic underneath them all.| [Subscribe to Sahil](https://sahilserver.substack.com/subscribe?)  
---|---  
