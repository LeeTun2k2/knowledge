...
**Today we’ll cover:**
  ...
  * End-to-end encryption[1](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-1-180511995) and key management
...
[![](https://substackcdn.com/image/fetch/$s_!_ADr!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fda02fc90-d534-4b88-b115-535e91d3bf56_2048x720.jpeg)](https://shorturl.at/inC96)
...
Hash user IDs to specific servers[2](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-2-180511995).
...
Redis Pub/Sub[3](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-3-180511995) is a lightweight messaging system built into Redis. It lets servers subscribe to channels and publish messages to those channels. Think of it like a radio station (channel) where servers can tune in to listen and broadcast messages.
  ...
  * Redis routes it to Server 2. Then Server 2 delivers to User B via WebSocket[4](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-4-180511995).

**Why we chose this:**

Redis Pub/Sub uses only a few bytes per channel (versus Kafka’s 50KB per topic).

It’s “at most once” delivery, meaning if no one’s listening when you publish, the message is lost. But that’s fine for our use case. We already have durability through the Message Queue[5](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-5-180511995) and database. Pub/Sub is just for real-time delivery to online users. If they’re offline, they still get messages from their inbox.
...
[![](https://substackcdn.com/image/fetch/$s_!RvJJ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7456f1e3-eb53-42b4-86f9-eddb02d0b8d6_1459x1114.png)](https://substackcdn.com/image/fetch/$s_!RvJJ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F7456f1e3-eb53-42b4-86f9-eddb02d0b8d6_1459x1114.png)
...
[![](https://substackcdn.com/image/fetch/$s_!cgS8!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdfba4b06-7347-4885-bc48-db7e53b17009_1600x562.png)](https://substackcdn.com/image/fetch/$s_!cgS8!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fdfba4b06-7347-4885-bc48-db7e53b17009_1600x562.png)
...
[![](https://substackcdn.com/image/fetch/$s_!McU-!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fef8114bc-701a-41e9-ada9-d24f61f86894_1600x692.png)](https://substackcdn.com/image/fetch/$s_!McU-!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fef8114bc-701a-41e9-ada9-d24f61f86894_1600x692.png)
...
If write fails:
  ...
  2. Check error type:
     ...
     * Temporary (connection timeout): Retry with exponential backoff[6](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-6-180511995)

     * Permanent (validation error): Move to dead-letter[7](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-7-180511995) queue for investigation
...
WhatsApp implements the Signal Protocol, which provides:
  ...
  * Forward secrecy[8](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-8-180511995) (compromising one message doesn’t compromise others)

  * Future secrecy (compromising a key doesn’t compromise future messages)

### **Key Exchange Flow:**

[![](https://substackcdn.com/image/fetch/$s_!jhZp!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa73e60ba-3905-4707-82bf-dac0e2ed1085_1488x1365.png)](https://substackcdn.com/image/fetch/$s_!jhZp!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fa73e60ba-3905-4707-82bf-dac0e2ed1085_1488x1365.png)
...
End-to-end encryption adds complexity.
  ...
  * Can’t provide message previews in push notifications[9](https://newsletter.systemdesign.one/p/design-a-chat-system#footnote-9-180511995) (would require server decryption)
...
[Subscribe](https://newsletter.systemdesign.one/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.systemdesign.one%2Fp%2Fdesign-a-chat-system&utm_source=paywall&utm_medium=web&utm_content=180511995)

[Already a paid subscriber? **Sign in**](https://substack.com/sign-in?redirect=%2Fp%2Fdesign-a-chat-system&for_pub=systemdesignone&change_user=false)
