...
Most developers jump straight into boxes and arrows without understanding the actual problems. They miss concurrency[1](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-1-182243684) traps, forget double booking[2](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-2-182243684), and can’t explain tradeoffs.
...
Booking Holdings reported over 1.1 billion room nights[6](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-6-182243684) in 2024.
...
**Bookings per second (TPS**[7](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-7-182243684)**):**
...
**Visits per second:**
  ...
  * Backend read QPS[8](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-8-182243684) ≈ 200 visits/s × 5 ≈ 1,000 read requests per second
...
[![](https://substackcdn.com/image/fetch/$s_!I8Be!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe657d908-5270-4bc2-b54c-dbdd9e7b4dc3_1600x1049.png)](https://substackcdn.com/image/fetch/$s_!I8Be!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fe657d908-5270-4bc2-b54c-dbdd9e7b4dc3_1600x1049.png)
...
**Services**
  ...
  * **Search Service** : Manages Elasticsearch[9](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-9-182243684) integration for hotel discovery.

**Data Layer**

  * **PostgreSQL** : Primary transactional store. ACID guarantees[10](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-10-182243684).
...
Split reservations and inventory into separate databases and coordinate with Saga patterns[11](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-11-182243684) or Two-Phase Commit[12](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-12-182243684) (**2PC**).
...
Saga patterns avoid locking but introduce eventual consistency[13](https://newsletter.systemdesign.one/p/airbnb-system-design#footnote-13-182243684), compensating actions, and complex failure handling. This is risky for user-facing booking flows where “eventually consistent” means angry users.
...
[![](https://substackcdn.com/image/fetch/$s_!ax2W!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2d1b2b74-6169-4544-8e2d-68a5814e2c47_1097x652.png)](https://substackcdn.com/image/fetch/$s_!ax2W!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F2d1b2b74-6169-4544-8e2d-68a5814e2c47_1097x652.png)
