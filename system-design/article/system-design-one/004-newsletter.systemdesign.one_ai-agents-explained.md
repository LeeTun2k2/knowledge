...
[![Sairam Sundaresan's avatar](https://substackcdn.com/image/fetch/$s_!3vud!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F79cc4b2d-3161-4743-85d8-97910007711b_1463x1463.jpeg)](https://substack.com/@sairamsundaresan)[![Neo Kim's avatar](https://substackcdn.com/image/fetch/$s_!OHOm!,w_36,h_36,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fc103940f-0d8b-47e7-9a33-013202e17bb8_389x389.jpeg)](https://substack.com/@systemdesignone)

[Sairam Sundaresan](https://substack.com/@sairamsundaresan) and [Neo Kim](https://substack.com/@systemdesignone)
...
Instead of writing code that clicks a specific element, you give an AI agent[1](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-1-183063799) a goal: “ _Find the cheapest flight to Tokyo this month_ ”.

In the best case, the agent can infer that “Lowest fare” is equivalent to “Cheapest” and choose the right control[2](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-2-183063799). Semantic robustness doesn’t happen automatically. Without explicit fallbacks and label-matching strategies, agents fail when UIs change. Even minor layout shifts, pop-ups, or accessibility features break them.
...
[![](https://substackcdn.com/image/fetch/$s_!UD1e!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F401f7956-4730-4e6c-a89b-428aa3ae5b5f_1600x800.png)](https://coderabbit.link/neo-kim)
...
[![](https://substackcdn.com/image/fetch/$s_!xRri!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F9785841d-a233-4b38-82bf-c8c40f124cee_803x413.png)](https://www.linkedin.com/in/sairam-sundaresan/)
...
[![](https://substackcdn.com/image/fetch/$s_!5bjJ!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fefefad33-4314-4f7b-972f-7d0fde84b7e2_1000x500.jpeg)](https://substackcdn.com/image/fetch/$s_!5bjJ!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fefefad33-4314-4f7b-972f-7d0fde84b7e2_1000x500.jpeg)
...
[![](https://substackcdn.com/image/fetch/$s_!hYxx!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb874f7a0-536e-4051-8c7a-b31c8ab2b993_1600x893.png)](https://substackcdn.com/image/fetch/$s_!hYxx!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fb874f7a0-536e-4051-8c7a-b31c8ab2b993_1600x893.png)

* * *

## **The Brain**

> A common mistake: treating Large Language Model[3](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-3-183063799) (**LLM**) as a knowledge base.
...
Before the agent charges your card, it should confirm key details: flight, price, and total. Then proceed. The fuzzy reasoning can propose actions. The final execution needs checkpoints[4](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-4-183063799).

### **The Context Window: Working Memory**

If the LLM is the processor, the _context window_[5](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-5-183063799) is its RAM.
...
[![](https://substackcdn.com/image/fetch/$s_!5bSu!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a701a24-4259-4ec6-aedb-20cc0fe22fc6_1600x883.png)](https://substackcdn.com/image/fetch/$s_!5bSu!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F5a701a24-4259-4ec6-aedb-20cc0fe22fc6_1600x883.png)

* * *

## **The Loop**

The engine that makes agents work is called **ReAct**[6](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-6-183063799): Reason plus Act.
...
[![](https://substackcdn.com/image/fetch/$s_!xaYj!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3139f56f-9d20-4c77-9f2d-2509f46b58bf_1600x873.png)](https://substackcdn.com/image/fetch/$s_!xaYj!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F3139f56f-9d20-4c77-9f2d-2509f46b58bf_1600x873.png)
...
An alternative pattern is called **Plan-and-Execute**[7](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-7-183063799).
...
To actually book a flight (to search, click, purchase, email), it needs tools[8](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-8-183063799).
...
[![](https://substackcdn.com/image/fetch/$s_!J1-u!,w_1456,c_limit,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fab01a97d-4c2b-4b3b-8e7f-4f23a319f7b0_1600x893.png)](https://substackcdn.com/image/fetch/$s_!J1-u!,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2Fab01a97d-4c2b-4b3b-8e7f-4f23a319f7b0_1600x893.png)
...
The dominant approach is called **RAG**[9](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-9-183063799) (Retrieval-Augmented Generation). Don’t load everything into the context window at once. Store information in a database and fetch only what’s relevant for what the agent is doing right now.

For our flight agent, imagine it needs to check your company’s travel policy:

The full policy is 50 pages, way too much for context. Instead, the policy is stored in a vector database[10](https://newsletter.systemdesign.one/p/ai-agents-explained#footnote-10-183063799). When the agent needs to know the maximum flight budget for Asia, it searches the database.
...
[Subscribe](https://newsletter.systemdesign.one/subscribe?simple=true&next=https%3A%2F%2Fnewsletter.systemdesign.one%2Fp%2Fai-agents-explained&utm_source=paywall&utm_medium=web&utm_content=183063799)

[Already a paid subscriber? **Sign in**](https://substack.com/sign-in?redirect=%2Fp%2Fai-agents-explained&for_pub=systemdesignone&change_user=false)

PreviousNext

[![Sairam Sundaresan's avatar](https://substackcdn.com/image/fetch/$s_!3vud!,w_52,h_52,c_fill,f_auto,q_auto:good,fl_progressive:steep/https%3A%2F%2Fsubstack-post-media.s3.amazonaws.com%2Fpublic%2Fimages%2F79cc4b2d-3161-4743-85d8-97910007711b_1463x1463.jpeg)](https://substack.com/@sairamsundaresan?utm_source=byline)| A guest post by| [Sairam Sundaresan](https://substack.com/@sairamsundaresan?utm_campaign=guest_post_bio&utm_medium=web)Author of AI for the Rest of Us and AI engineering leader with 15+ years of industry experience. I help tech professionals break into AI and companies build valuable products through my writing and teaching.| [Subscribe to Sairam](https://newsletter.artofsaience.com/subscribe?)  
---|---  
